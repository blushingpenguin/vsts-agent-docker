...
$vstsUrl = "https://$vstsAccount.visualstudio.com/_apis/distributedtask/packages/agent?platform=win7-x64&`$top=1"
...
docker build -t microsoft/vsts-agent:latest --build-arg AGENT_FILENAME=$fn .
